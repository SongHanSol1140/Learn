...
// 각 줄마다 1 이상 99999 이하의 정수가 주어진다. 입력의 마지막 줄에는 0이 주어지며, 이 줄은 문제에 포함되지 않는다.
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        for(String item : lines){
            String SBText = new StringBuilder(item).reverse().toString();
            var answer = item.equals(SBText)? "yes": "no";
